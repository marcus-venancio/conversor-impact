...
emails = ['' for _ in range(len(clientes_afetados))]
for i, cliente_afetado in enumerate(clientes_afetados):
...
dados = {'Cliente afetado': clientes_afetados, 'Circuito': circuito,
         'Morada': morada_cliente, 'E-mails de contato': emails}
